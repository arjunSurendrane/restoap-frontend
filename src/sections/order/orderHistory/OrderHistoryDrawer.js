...
import { OrderInvoiceTablle } from '../liveOrders';
import OrderAddonsTablle from '../liveOrders/OrderAddonsTable';
import KitchenInvoiceTable from '../liveOrders/kitchenInvoiceTable';
import CashierIAddonsTable from '../liveOrders/CashierIAddonsTable';
import CashierInvoiceTable from '../liveOrders/CashierInvoiceTable';
import HistoryInvoiceTable from './HistoryInvoiceTable';
import HistoryAddonsTable from './HistoryAddonsTable';

// ----------------------------------------------------------------------

OrderHistoryDrawer.propTypes = {
...
// ----------------------------------------------------------------------
export default function OrderHistoryDrawer({ data, open, onOpen, onClose }) {
        ...
        <Scrollbar>
          <Stack spacing={3} sx={{ p: 2.5 }}>
            <Stack spacing={1}>
              ...
              <Typography variant="subtitle1">
                Customer Name : {data?.customer?.firstName}{' '}
              </Typography>
            </Stack>
          ...
          <Stack spacing={1}>
            <Stack spacing={3} sx={{ p: 2.5, display: 'flex', spacing: 5 }}>
              <HistoryInvoiceTable data={items} />
            </Stack>
            ...
            {addOns && <HistoryAddonsTable data={addOns} />}
          </Stack>
          ...
          <Box>
            <Stack spacing={3} sx={{ p: 2.5, display: 'flex', spacing: 5 }}>
              ...
              <Box sx={{ display: 'flex', justifyContent: 'space-between' }}>
                ...
                <Box>
                  {' '}
                  <Typography variant="subtitle2">{data?.grossAmount}</Typography>
                </Box>
              </Box>
              <Box sx={{ display: 'flex', justifyContent: 'space-between' }}>
                <Box>
