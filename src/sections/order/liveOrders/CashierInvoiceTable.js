...
CashierInvoiceTable.propTypes = {
  data: PropTypes.object,
};

function CashierInvoiceTable({ data }) {
        ...
        <TableBody>
          {data.map((row) => (
            ...
            >
              ...
              {isverified ? (
                <TableCell>
                  <Button sx={{ backgroundColor: `${itemStatus[row.status]}`, color: 'white' }}>
                    {row.status}
                  </Button>
                </TableCell>
              ) : (
...
export default CashierInvoiceTable;
